...
.method private defaultStartAlarm()V
    ...
    iput-object v1, p0, Lcom/sec/android/app/clockpackage/timer/TimerService;->mediaPlayer:Landroid/media/MediaPlayer;

    .line 600
    iget-object v1, p0, Lcom/sec/android/app/clockpackage/timer/TimerService;->mediaPlayer:Landroid/media/MediaPlayer;
    ...
    .line 607
    sget-object v1, Lcom/sec/android/app/clockpackage/timer/TimerService;->alarmogg:Ljava/lang/String;

    invoke-static {v1}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v1

    iput-object v1, p0, Lcom/sec/android/app/clockpackage/timer/TimerService;->mSoundUri:Landroid/net/Uri;

    .line 609
    iget-object v1, p0, Lcom/sec/android/app/clockpackage/timer/TimerService;->mediaPlayer:Landroid/media/MediaPlayer;

    iget-object v2, p0, Lcom/sec/android/app/clockpackage/timer/TimerService;->mSoundUri:Landroid/net/Uri;

    invoke-virtual {v1, p0, v2}, Landroid/media/MediaPlayer;->setDataSource(Landroid/content/Context;Landroid/net/Uri;)V

    .line 615
    iget-object v1, p0, Lcom/sec/android/app/clockpackage/timer/TimerService;->audioManager:Landroid/media/AudioManager;

    const/4 v2, 0x4

    iget v3, p0, Lcom/sec/android/app/clockpackage/timer/TimerService;->volumeValue:I
    ...
    :try_end_47
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_47} :catch_48
    .catch Ljava/lang/NullPointerException; {:try_start_1 .. :try_end_47} :catch_57
    ...
    const-string v2, "MediaPlayer is not normal state retry it."

    invoke-static {v1, v2}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 633
    invoke-direct {p0, v5}, Lcom/sec/android/app/clockpackage/timer/TimerService;->startRing(Z)V
...
.method private startRing(Z)V
    ...
    .catch Ljava/lang/NullPointerException; {:try_start_41 .. :try_end_7e} :catch_be
    ...
    iget v6, p0, Lcom/sec/android/app/clockpackage/timer/TimerService;->volumeValue:I

    const/4 v7, 0x0

    invoke-virtual {v4, v5, v6, v7}, Landroid/media/AudioManager;->setStreamVolume(III)V
    :try_end_bd
    .catch Ljava/io/IOException; {:try_start_ab .. :try_end_bd} :catch_7f
    .catch Ljava/lang/NullPointerException; {:try_start_ab .. :try_end_bd} :catch_be
